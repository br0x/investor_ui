...
export class JettonWallet implements Contract {
    ...
    static transferMessage(query_id: bigint, jetton_amount: bigint, to: Address,
                           responseAddress:Address | null,
                           customPayload: Cell | null,
                           forward_ton_amount: bigint,
                           forwardPayload: Cell | null) {

        return beginCell().storeUint(Op.transfer, 32)
    ...
    async sendTransfer(provider: ContractProvider, via: Sender,
        ...
        await provider.internal(via, {
            sendMode: SendMode.PAY_GAS_SEPARATELY,
            body: JettonWallet.transferMessage(queryId, jetton_amount, to, responseAddress, customPayload, forward_ton_amount, forwardPayload),
            value: value
        });
